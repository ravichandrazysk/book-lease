...
export function CategorySection({
  ...
  return (
    <div className="flex-1 sm:max-w-4xl mx-auto max-w-sm pt-4">
      <div className="mb-1 flex items-center gap-4 max-md:mx-auto max-sm:w-[345px]">
        <Button
          variant="ghost"
          size="icon"
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 mt-2 max-md:mx-auto max-sm:w-[345px]">
