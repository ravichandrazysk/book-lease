...
const HomePage = () => {
  ...
  return (
    <React.Fragment>
      <div className="max-sm:max-w-[345px] max-w-sm sm:max-w-[1340px] mx-auto">
        {/* <section id="email-verify-button" className="mt-2">
          <EmailVerifyCard onVerify={handleEamilVerify} />
        </section> */}
        <section id="promotion-banner" className="max-w-[1340px] mx-auto mt-2">
            ...
            <div className=" ">
              <div className="">
                <Image
                  ...
                  width={240}
                  height={800}
                  className=" w-[1024px] max-w-5xl mx-auto h-96 max-h-96 max-sm:max-w-sm"
                />
